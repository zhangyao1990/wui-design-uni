  ...
  <page-wraper>
    <view>
      <demo-block title="基本用法">
        <wui-notice-bar text="这是一条消息提示信息这是一条消息提示信息这是一条消息提示信息" prefix="warn-bold" />
      </demo-block>
      ...
      <demo-block title="禁止滚动">
        <wui-notice-bar :scrollable="false" text="通知被禁或时段内消息屏蔽可能造成消…" prefix="warn-bold"></wui-notice-bar>
      </demo-block>

      <demo-block title="插槽">
        <wui-notice-bar :scrollable="false">
          <template #prefix>
            <wui-icon custom-class="prefix" name="warn-bold">占位符</wui-icon>
          </template>
          通知被禁或时段内消息屏蔽可能造成消…
          <template #suffix>
      ...
      <demo-block title="可关闭的">
        <wui-notice-bar text="挂起后，电脑与手机均不会有新客户接入。挂起后，电脑与手机均不会有新客户接入。" closable prefix="warn-bold" />
      </demo-block>
      ...
      <demo-block title="多文本轮播">
        <wui-notice-bar @click="handleClick" :text="textArray" prefix="check-outline" @next="onNext" />
      </demo-block>

      <demo-block title="垂直滚动">
        <wui-notice-bar @click="handleClick" prefix="warn-bold" direction="vertical" :text="textArray" :delay="3" custom-class="space" />
        <wui-notice-bar @click="handleClick" prefix="warn-bold" direction="vertical" text="只有一条消息不会滚动" :delay="3" custom-class="space" />
      </demo-block>

      <demo-block title="重置播放动画">
        <wui-notice-bar ref="notice" prefix="warn-bold" direction="vertical" :text="textArray" :delay="3" custom-class="space" />
