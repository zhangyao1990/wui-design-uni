  ...
  <page-wraper>
    <demo-block title="基础表单" transparent>
      <wui-form ref="form1" :model="model1">
        ...
        <view class="footer">
          <wui-button type="primary" size="large" @click="handleSubmit1" block>提交</wui-button>
        </view>
      </wui-form>
    </demo-block>

    <demo-block title="校验规则" transparent>
      <wui-form ref="form2" :model="model2">
        <wui-cell-group border>
          <wui-input
            label="校验"
            label-width="100px"
        ...
        <view class="footer">
          <wui-button type="primary" size="large" @click="handleSubmit2" block>提交</wui-button>
        </view>
      </wui-form>
    </demo-block>
    ...
    <demo-block title="动态表单" transparent>
      <view class="demo-button">
        <wui-button @click="handleClick1" :round="false" block size="large">动态表单</wui-button>
      </view>
    </demo-block>

    <demo-block title="失焦校验" transparent>
      <view class="demo-button">
        <wui-button @click="handleClick2" :round="false" block size="large">失焦校验</wui-button>
      </view>
    </demo-block>

    <demo-block title="复杂表单" transparent>
      <view class="demo-button">
        <wui-button @click="handleClick3" :round="false" block size="large">复杂表单</wui-button>
      </view>
    </demo-block>

    <demo-block title="校验提示方式" transparent>
      <view class="demo-button">
        <wui-button @click="handleClick4" :round="false" block size="large">校验提示方式</wui-button>
      </view>
    </demo-block>
  </page-wraper>
</template>
