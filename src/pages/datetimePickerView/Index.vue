<template>
  <page-wraper>
    ...
    <demo-block title="年月" transparent>
      <wui-datetime-picker-view type="year-month" v-model="value3" @change="onChange3" />
    </demo-block>

    <demo-block title="年" transparent>
      <wui-datetime-picker-view type="year" v-model="value7" @change="onChange7" />
    </demo-block>
    ...
    <demo-block title="过滤选项" transparent>
      <wui-datetime-picker-view v-model="value6" :filter="filter" @change="onChange6" />
    </demo-block>
  </page-wraper>
</template>
