  ...
  <view @click="closeOutside">
    ...
    <page-wraper>
      <demo-block title="基本用法" transparent>
        <wui-search v-model="value1" @search="search" @change="change" @cancel="cancel" @clear="clear" />
      </demo-block>
      ...
      <demo-block title="设置最大长度" transparent>
        <wui-search v-model="value2" :maxlength="4" />
      </demo-block>

      <demo-block title="清空后自动聚焦" transparent>
        <wui-search v-model="value4" focus-when-clear />
      </demo-block>

      <demo-block title="自动聚焦" transparent>
        <wui-search v-model="value5" focus />
      </demo-block>
    </page-wraper>
  </view>
</template>
