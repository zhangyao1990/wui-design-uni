...
import type { SegmentedOption } from '@/uni_modules/wui-design-uni/components/wui-segmented/types'
import { ref } from 'vue'
...
const list1 = ref([
  ...
  },
  {
    ...
    disabled: true,
    payload: {
      avatar: 'https://registry.npmmirror.com/wui-design-uni-assets/*/files/panda.jpg'
    }
  },
  {
    value: 'Tom',
    disabled: false,
    payload: {
      avatar: 'https://registry.npmmirror.com/wui-design-uni-assets/*/files/meng.jpg'
    }
  }
])
