  ...
  <page-wraper>
    ...
    <demo-block transparent>
      <wui-cell-group border>
        ...
        <wui-datetime-picker label="before-confirm" v-model="value8" :before-confirm="beforeConfirm" @confirm="handleConfirm8" />
        <wui-datetime-picker label="错误" v-model="value9" error @confirm="handleConfirm9" />
        <wui-datetime-picker label="必填" v-model="value10" required @confirm="handleConfirm10" />
        <wui-datetime-picker label="默认日期" v-model="value2" :default-value="value2" />
        <wui-datetime-picker label="时间范围一年" :minDate="minDate" :maxDate="maxDate" v-model="value17" @confirm="handleConfirm1" />
      </wui-cell-group>
    </demo-block>
    <demo-block title="label 不传" transparent>
      <wui-datetime-picker v-model="value11" @confirm="handleConfirm11" />
    </demo-block>
    <demo-block title="大小" transparent>
      <wui-datetime-picker label="日期选择" size="large" v-model="value12" @confirm="handleConfirm12" />
    </demo-block>
    <demo-block title="值靠右展示" transparent>
      <wui-datetime-picker label="日期选择" align-right v-model="value13" @confirm="handleConfirm13" />
    </demo-block>
...
import type { DatetimePickerViewFilter, DatetimePickerViewFormatter } from '@/uni_modules/wui-design-uni/components/wui-datetime-picker-view/types'
import type {
  DatetimePickerDisplayFormat,
  DatetimePickerDisplayFormatTabLabel,
  DatetimePickerInstance
} from '@/uni_modules/wui-design-uni/components/wui-datetime-picker/types'
import { ref } from 'vue'
