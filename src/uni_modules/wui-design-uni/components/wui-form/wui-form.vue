<template>
  <view :class="`wui-form ${customClass}`" :style="customStyle">
    <slot></slot>
    <wui-toast v-if="props.errorType === 'toast'" selector="wui-form-toast" />
  </view>
</template>
...
const { show: showToast } = useToast('wui-form-toast')
