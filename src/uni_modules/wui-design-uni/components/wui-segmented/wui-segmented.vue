<template>
  <view :class="`wui-segmented ${customClass}`" :style="customStyle">
    <view
      :class="`wui-segmented__item is-${size} ${state.activeIndex === index ? 'is-active' : ''} ${
      ...
      :key="index"
    >
      <view class="wui-segmented__item-label">
    ...
    <view :class="`wui-segmented__item--active ${activeDisabled ? 'is-disabled' : ''}`" :style="state.activeStyle"></view>
  </view>
</template>
...
const $item = '.wui-segmented__item'
