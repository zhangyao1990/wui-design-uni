<template>
  <view class="wui-month-panel">
    <view v-if="showPanelTitle" class="wui-month-panel__title">
      {{ title }}
    </view>
    <view class="wui-month-panel__weeks">
      <view v-for="item in 7" :key="item" class="wui-month-panel__week">{{ weekLabel(item + firstDayOfWeek) }}</view>
    </view>
    <scroll-view
      :class="`wui-month-panel__container ${!!timeType ? 'wui-month-panel__container--time' : ''}`"
    ...
    <view v-if="timeType" class="wui-month-panel__time">
      <view v-if="type === 'datetimerange'" class="wui-month-panel__time-label">
        <view class="wui-month-panel__time-text">{{ timeType === 'start' ? translate('startTime') : translate('endTime') }}</view>
      </view>
      <view class="wui-month-panel__time-picker">
        <wui-picker-view
...
import wuiPickerView from '../../wui-picker-view/wui-picker-view.vue'
