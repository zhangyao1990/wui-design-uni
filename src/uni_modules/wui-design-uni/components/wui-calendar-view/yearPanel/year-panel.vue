<template>
  <view class="wui-year-panel">
    <view v-if="showPanelTitle" class="wui-year-panel__title">{{ title }}</view>
    <scroll-view class="wui-year-panel__container" :style="`height: ${scrollHeight}px`" scroll-y @scroll="yearScroll" :scroll-top="scrollTop">
