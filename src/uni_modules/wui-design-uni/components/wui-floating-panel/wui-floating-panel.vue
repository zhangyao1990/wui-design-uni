<template>
  <view
    :class="`wui-floating-panel ${customClass} ${safeAreaInsetBottom ? 'is-safe' : ''}`"
    :style="rootStyle"
  ...
  >
    <view :class="`wui-floating-panel__header`">
      <view :class="`wui-floating-panel__header-bar`"></view>
    </view>

    <scroll-view
      :class="`wui-floating-panel__content`"
      data-id="content"
