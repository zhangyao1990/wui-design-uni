 ...
 * @Description:
 * @FilePath: \wui-design-uni\src\uni_modules\wui-design-uni\components\wui-status-tip\types.ts
 * 记得注释
 */
import type { ExtractPropTypes, PropType } from 'vue'
import { baseProps, makeStringProp } from '../common/props'
import type { ImageMode } from '../wui-img/types'
...
export const statusTipProps = {
   ...
   * 类型: string
   * 默认值: https://registry.npmmirror.com/wui-design-uni-assets/*\/files/
   */
  urlPrefix: makeStringProp('https://registry.npmmirror.com/wui-design-uni-assets/*/files/')
}
