 ...
 * @Description:
 * @FilePath: \wui-design-uni\src\uni_modules\wui-design-uni\components\wui-cell-group\types.ts
 * 记得注释
 */
...
export const CELL_GROUP_KEY: InjectionKey<CelllGroupProvide> = Symbol('wui-cell-group')
