...
const locationUrl = 'https://zhangyao1990.github.io/wui-design-uni'
const baseUrl =
  process.env.NODE_ENV === 'production' ? `${locationUrl}/demo/?timestamp=${new Date().getTime()}#/` : 'http://localhost:5173/demo/#/'
