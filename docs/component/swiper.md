...
const swiperList = ref([
  'https://registry.npmmirror.com/wui-design-uni-assets/*/files/redpanda.jpg',
  'https://registry.npmmirror.com/wui-design-uni-assets/*/files/capybara.jpg',
  'https://registry.npmmirror.com/wui-design-uni-assets/*/files/panda.jpg',
  'https://registry.npmmirror.com/wui-design-uni-assets/*/files/moon.jpg',
  'https://registry.npmmirror.com/wui-design-uni-assets/*/files/meng.jpg'
])
...
```html
<wui-swiper :list="swiperList" autoplay v-model:current="current" :indicator="{ type: 'dots-bar' }" @click="handleClick" @change="onChange"></wui-swiper>
```
...
```ts
const videoList = ref([
  'https://unpkg.com/wui-design-uni-assets@1.0.3/VID_115503.mp4',
  'https://unpkg.com/wui-design-uni-assets@1.0.3/VID_150752.mp4',
  'https://unpkg.com/wui-design-uni-assets@1.0.3/VID_155516.mp4',
  'https://registry.npmmirror.com/wui-design-uni-assets/*/files/moon.jpg'
])
```
...
```ts
const videoList = ref([
  'https://unpkg.com/wui-design-uni-assets/VID_115503.mp4',
  'https://unpkg.com/wui-design-uni-assets/VID_150752.mp4',
  'https://unpkg.com/wui-design-uni-assets/VID_155516.mp4'
])
```
...
```html
<wui-swiper :list="swiperList" direction="vertical" indicatorPosition="right" autoplay v-model:current="current" @click="handleClick" @change="onChange">
...
```html
<wui-swiper value-key="url" text-key="title" :custom-text-style="color:#fff" :list="customSwiperList" autoplay v-model:current="current" @click="handleClick" @change="onChange"></wui-swiper>
```
```ts
const current = ref<number>(0)

const customSwiperList = ref([
  { url: 'https://registry.npmmirror.com/wui-design-uni-assets/*/files/redpanda.jpg', title: '小熊猫！' },
  { url: 'https://registry.npmmirror.com/wui-design-uni-assets/*/files/capybara.jpg', title: '卡！皮！巴！拉！' },
  { url: 'https://registry.npmmirror.com/wui-design-uni-assets/*/files/panda.jpg', title: '大熊猫！' },
  { url: 'https://registry.npmmirror.com/wui-design-uni-assets/*/files/moon.jpg', title: '诗画中国！' }
])
```
```scss
