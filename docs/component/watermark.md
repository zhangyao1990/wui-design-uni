...
```html
<wui-watermark content="wui-design-uni" :width="130" :height="130"></wui-watermark>
```
...
```html
<wui-watermark image="https://wui-design-uni.cn/wui-design.png" :image-width="38" :image-height="38"></wui-watermark>
...
```html
<wui-watermark content="wui-design-uni" :full-screen="false"></wui-watermark>
```
...
```html
<wui-watermark content="wui-design-uni" :opacity="0.4"></wui-watermark>
```
