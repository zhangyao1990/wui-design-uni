...
```html
<wui-toast />
<wui-button @click="showActions">弹出菜单</wui-button>
<wui-action-sheet v-model="show" :actions="actions" @close="close" @select="select" />
```
...
```html
<wui-button @click="showActions">弹出菜单</wui-button>
<wui-action-sheet v-model="show" :actions="actions" @close="close" />
```
...
```html
<wui-action-sheet v-model="show" :actions="actions" @close="close" cancel-text="取消" />
```
...
```html
<wui-button @click="showActions">弹出菜单</wui-button>
<wui-action-sheet v-model="show" :panels="panels" @close="close" @select="select" />
```
...
```html
<wui-action-sheet v-model="show" title="标题" @close="close">
