...
const tsFilePath = path.resolve(__dirname, '../src/uni_modules/wui-design-uni/components/wui-config-provider/types.ts')
const scssFilePath = path.resolve(__dirname, '../src/uni_modules/wui-design-uni/components/common/abstracts/variable.scss')
