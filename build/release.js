 ...
 * @Description: 组件发版问答
 * @FilePath: \wui-design-uni\build\release.js
 * 记得注释
 */
...
const src = path.resolve(__dirname, '../src/uni_modules/wui-design-uni')
...
inquirer
  ...
  .then((answers) => {
    ...
    const package = require('../src/uni_modules/wui-design-uni/package.json')
